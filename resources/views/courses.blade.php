<x-app-layout>
    ...
    <div class="container my-4" style="padding: 5rem; padding-top: 0;">
        <div class="d-flex justify-content-center align-items-center mb-4 rounded-pill border-2" style="gap: 3rem;">
            <form action="{{ route('courses') }}" method="GET" style="width: 25rem;"
            ...
            <div class="justify-content-center d-flex" style="gap: 2rem; width: 25rem">
                <a href="{{ route('courses') }}" class="tab-link active">All</a>
                <a href="{{ route('archived') }}" class="tab-link">Archived</a>
            </div>
            <div style="width: 25rem" class="justify-content-end d-flex">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                        <li>
                            <a class="dropdown-item fw-bold" href="{{ route('courses', ['filter' => ' ']) }}">All Courses</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Piano']) }}">Piano</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Guitar']) }}">Guitar</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Drum']) }}">Drum</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Vocal']) }}">Vocal</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Violin']) }}">Violin</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('courses', ['filter' => 'Saxophone']) }}">Saxophone</a>
                        </li>
                    </ul>
                </div>
            </div>
